...
\definecolor{PratPurple}{HTML}{5B2C6F}
\definecolor{PratPurpleBg}{HTML}{F4ECF7}
...
% Caixa "pratica agora": exercícios sugeridos para fazer sozinho, colocada no
% fim de cada tópico (##) logo a seguir à teoria que os exercícios aplicam
\newtcolorbox{pratica}[1][]{colback=PratPurpleBg,colframe=PratPurple,fonttitle=\bfseries,title={Pratica agora\ #1},left=6pt,right=6pt,top=3pt,bottom=3pt}
